...
public class ElementSlider extends Element {
    ...
    public void drawScreen(int x, int y, int mouseX, int mouseY) {
        ...
        percent = Math.min((((NumberValue) setting).getValue().doubleValue() - ((NumberValue) setting).getMin().doubleValue()) / (((NumberValue) this.setting).getMax().doubleValue() - ((NumberValue) setting).getMin().doubleValue()), 1D);
