package me.aerclient.implementation.utils.player;
...
public class PlayerUtil implements Utilities {
    ...
    public static boolean hasSpaceToMove() {
        return WorldUtils.isSpaceForPlayerAt(minecraft.player.posX, minecraft.player.posY, minecraft.player.posZ);
    }
