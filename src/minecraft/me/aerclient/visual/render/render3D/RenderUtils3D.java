package me.aerclient.visual.render.render3D;
 ...
 */
public class RenderUtils3D implements Utilities {
	...
	public static void drawOutlinedBlockESP(BlockPos blockIn, float red, float green, float blue, float alpha, float lineWidth) {
		double x = (blockIn.getX() - minecraft.player.posX) + (minecraft.player.posX - minecraft.getRenderManager().renderPosX);
		double y = (blockIn.getY() - minecraft.player.posY) + (minecraft.player.posY - minecraft.getRenderManager().renderPosY);
		double z = (blockIn.getZ() - minecraft.player.posZ) + (minecraft.player.posZ - minecraft.getRenderManager().renderPosZ);
	...
	public static void drawTracerLine(Entity entityIn, float red, float green, float blue, float alpha, float lineWdith) {
		double x = (entityIn.posX - minecraft.player.posX) + (minecraft.player.posX - minecraft.getRenderManager().renderPosX);
		double y = (entityIn.posY - minecraft.player.posY) + (minecraft.player.posY - minecraft.getRenderManager().renderPosY);
		double z = (entityIn.posZ - minecraft.player.posZ) + (minecraft.player.posZ - minecraft.getRenderManager().renderPosZ);
		Vec3d eyes = new Vec3d(0.0D, 0.0D, 100.0D)
				.rotatePitch((float) Math.toRadians(-minecraft.player.rotationPitch))
				.rotateYaw((float) Math.toRadians(-minecraft.player.rotationYaw));
	...
	public static void drawTracerLine(BlockPos pos, float red, float green, float blue, float alpha, float lineWdith) {
		double x = (pos.getX() - minecraft.player.posX) + (minecraft.player.posX - minecraft.getRenderManager().renderPosX) + 0.5d;
		double y = (pos.getY() - minecraft.player.posY) + (minecraft.player.posY - minecraft.getRenderManager().renderPosY);
		double z = (pos.getZ() - minecraft.player.posZ) + (minecraft.player.posZ - minecraft.getRenderManager().renderPosZ) + 0.5d;
		Vec3d eyes = new Vec3d(0.0D, 0.0D, 100.0D)
				.rotatePitch((float) Math.toRadians(-minecraft.player.rotationPitch))
				.rotateYaw((float) Math.toRadians(-minecraft.player.rotationYaw));
		drawTracerLine(x, y, z, eyes.xCoord, eyes.yCoord, eyes.zCoord, red, green, blue, alpha, lineWdith);
	...
	public static void drawTracerLine(BlockPos pos, BlockPos pos1, float red, float green, float blue, float alpha, float lineWdith) {
		...
		double x1 = (pos1.getX() - minecraft.player.posX) + (minecraft.player.posX - minecraft.getRenderManager().renderPosX) + 0.5d;
		double y1 = (pos1.getY() - minecraft.player.posY) + (minecraft.player.posY - minecraft.getRenderManager().renderPosY);
		double z1 = (pos1.getZ() - minecraft.player.posZ) + (minecraft.player.posZ - minecraft.getRenderManager().renderPosZ) + 0.5d;
	...
	public static void drawOutlinedESPBox(AxisAlignedBB box, float red, float green, float blue, float alpha, float lineWidth) {
		double x = (box.maxX - minecraft.player.posX) + (minecraft.player.posX - minecraft.getRenderManager().renderPosX);
		double y = (box.maxY - minecraft.player.posY) + (minecraft.player.posY - minecraft.getRenderManager().renderPosY);
		double z = (box.maxZ - minecraft.player.posZ) + (minecraft.player.posZ - minecraft.getRenderManager().renderPosZ);
		double x2 = (box.minX - minecraft.player.posX) + (minecraft.player.posX - minecraft.getRenderManager().renderPosX);
		double y2 = (box.minY - minecraft.player.posY) + (minecraft.player.posY - minecraft.getRenderManager().renderPosY);
		double z2 = (box.minZ - minecraft.player.posZ) + (minecraft.player.posZ - minecraft.getRenderManager().renderPosZ);
