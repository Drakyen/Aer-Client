...
public class MinimalSlider extends Slider {
    ...
    public void render(int mouseX, int mouseY) {
        ...
        rend2D.drawRect(x + 12, y + 1, x + width - 6, y + height, foregroundCol.brighter().getRGB());
        if (hovered(mouseX, mouseY) && parent.getParent().getParent().allowAction(parent.getParent(), mouseX, mouseY)) {
            rend2D.drawRect(x + 12, y + 1, (int) stretch, y + height, transparentCol.darker().getRGB());
        } else {
            rend2D.drawRect(x + 12, y + 1, (int) stretch, y + height, transparentCol.getRGB());
        }
