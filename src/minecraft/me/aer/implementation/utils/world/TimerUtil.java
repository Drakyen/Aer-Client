...
public class TimerUtil {
     ...
     */
    private static HashMap<Object, Integer> timers = new HashMap<>();

    /**
     * HashMap that tracks what method in each object should be called
     */
    private static HashMap<Object, Method> methods = new HashMap<>();
    ...
    private static void increment() {
        for (Map.Entry<Object, Integer> entry : timers.entrySet()) {
    ...
    public static void update() {
         ...
         */
        long elapsedTime = i - lastSyncedTime;
        lastSyncedTime = i;
        time += elapsedTime;
