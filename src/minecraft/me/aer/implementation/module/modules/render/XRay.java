...
import me.aer.config.valuesystem.BlockArrayValue;
...
import me.aer.injection.events.render.EventRenderBlock;
import me.aer.injection.events.world.EventWorldLoaded;
...
public class XRay extends Module {
	...
	public void onEnable() {
        ...
        WorldUtil.setBlocksTransparent(true, true);
	...
	public void onDisable() {
        ...
        WorldUtil.setBlocksTransparent(false, true);
        WorldUtil.setCulling(true, true);
        minecraft.world.markBlockRangeForRenderUpdate((int) minecraft.player.posX - 128, (int) minecraft.player.posY - 128, (int) minecraft.player.posZ - 128, (int) minecraft.player.posX + 128, (int) minecraft.player.posY + 128, (int) minecraft.player.posZ + 128);
