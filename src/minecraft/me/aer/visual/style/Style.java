...
public abstract class Style implements Utilities  {
    ...
    public Element getNewElement(int x, int y, Value value, ModuleButton parent) {
        ...
        if (value instanceof ColourValue) {
            return getNewColourPicker(x, y, value, parent);
        }
        return null;
    }

    protected abstract ColourPicker getNewColourPicker(int x, int y, Value value, ModuleButton parent);
