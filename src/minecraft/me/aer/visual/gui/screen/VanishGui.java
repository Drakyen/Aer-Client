package me.aer.visual.gui.screen;
...
public class VanishGui extends GuiScreen implements Utilities {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        rend.drawCenteredString(Fonts.massive, "Reloading world...", scaledRes.getScaledWidth() / 2, scaledRes.getScaledHeight() / 2, 0xaaffffff, true);
        if (timeout <= 7) {
            rend.drawCenteredString(Fonts.mid, "Timing out in: " + timeout, scaledRes.getScaledWidth() / 2, (scaledRes.getScaledHeight() / 2) + 45, 0xaaffffff, true);
        }
    }
