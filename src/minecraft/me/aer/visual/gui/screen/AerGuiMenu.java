...
import me.aer.visual.gui.screen.login.GuiAltLogin;
...
public class AerGuiMenu extends GuiScreen implements Utilities {
    ...
    public AerGuiMenu() {
        ...
        LOGO = rend.loadTexture512("aerassets/logo.png");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        rend.drawRect(j + 20, (height / 16) + 30, j + 80, (height / 16) + 70, rainbow.getRGB());
        rend.enableBlending();
