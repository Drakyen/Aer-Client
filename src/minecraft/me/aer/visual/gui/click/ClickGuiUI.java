package me.aer.visual.gui.click;
...
import me.aer.visual.gui.click.base.Element;
...
public class ClickGuiUI extends GuiScreen implements Utilities {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        rend.enableArray(GL11.GL_VERTEX_ARRAY);
        rend.enableBlending();
        ...
        rend.disableArray(GL11.GL_VERTEX_ARRAY);
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        for(Panel p : panels) {
            p.keyPressed(typedChar, keyCode);
        }
    }
