...
public class CustomFontRenderer {
    ...
    /*
     * The name of the font renderer
     */
    public String name;

    public CustomFontRenderer(Font font, String name) {
        this(font, 256, name);
    }

    public CustomFontRenderer(Font font, int characterCount, String name) {
        this(font, characterCount, false, name);
    }

    public CustomFontRenderer(Font font, boolean fractionalMetrics, String name) {
        this(font, 256, fractionalMetrics, name);
    }

    public CustomFontRenderer(Font font, int characterCount, boolean fractionalMetrics, String name) {
        this.font = font;
        this.fractionalMetrics = fractionalMetrics;

        this.margin = fractionalMetrics ? 6 : 4;
    ...
    private void renderString(String text, float x, float y, int color, boolean shadow) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            // Continues if the previous char was the color invoker.
            ...
            if (character == COLOR_INVOKER && i < length) {
                ...
                int index = "0123456789abcdefklmnorp".indexOf(text.toLowerCase(Locale.ENGLISH).charAt(i + 1));
    ...
    class CharacterData {
        ...
        private CharacterData(char character, float width, float height, int textureId) {
