...
public class ClickGui extends Module {
    ...
    private NumberValue<Float> red = new NumberValue<>("Red", 0.5f, 0.0f, 1f);
    private NumberValue<Float> green = new NumberValue<>("Green", 0.9f, 0.0f, 1f);
    private NumberValue<Float> blue = new NumberValue<>("Blue", 0.6f, 0.0f, 1f);
    private NumberValue<Float> alpha = new NumberValue<>("Alpha", 0.8f, 0.5f, 1f);
